    ...
    return (
        <div className="w-full h-full relative">
            <motion.div initial={{ opacity: 0 }} animate={{
                ...
                }} className="w-[200px] h-[300px] translate-x-16 xl:w-[358px] xl:h-[498px] mix-blend-lighten absolute  xl:translate-x-16">
                    <Image src="/assets/Eu.png" priority quality={100} fill alt="Minha foto" className="object-contain" />
                </motion.div>
